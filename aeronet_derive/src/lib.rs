...
// ///
// /// * `#[channel_type(type)]` determines what `type` implementing
// [`Channels`] ///   variants of this type can be sent along.
// /// * `#[on_channel(value)]` determines what value of type `type` this
// variant ///   is sent along.
// ///
// /// # Usage
// ///
// /// ## Struct
