...
pub struct SteamNetDedicatedServerPlugin;

impl Plugin for SteamNetDedicatedServerPlugin {
...
pub struct SteamNetDedicatedServer {
    mtu: usize,
    clients: HashMap<SteamId, Entity>,
}

impl SteamNetDedicatedServer {
...
fn poll_opening(
    ...
    mut servers: Query<(Entity, &mut Opening), With<SteamNetDedicatedServer>>,
) {
...
fn poll_opened(
    mut commands: Commands,
    mut servers: Query<(Entity, &mut Opened, &mut SteamNetDedicatedServer)>,
) {
...
fn on_connecting(
    ...
    server_io: &mut SteamNetDedicatedServer,
...
fn on_connected(
    commands: &mut Commands,
    server_io: &SteamNetDedicatedServer,
...
fn on_remove_client(
    ...
    mut servers: Query<&mut SteamNetDedicatedServer>,
) -> Result<(), BevyError> {
