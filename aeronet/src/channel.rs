...
// /// Represents an instance of a method used to transport data along a
// /// connection.
// /// 
// /// Since a [`ChannelKind`] represents a *kind* of channel, this type
// /// represents the *channel itself*. A connection may have multiple channels of
// /// the same type open at once, and this type is used to differentiate the
// /// different channels.
// #[derive(Debug, Clone, Copy, PartialEq, Eq, Hash)]
// pub struct ChannelId {
//     /// The kind of channel this represents.
//     pub kind: ChannelKind,
//     /// The index of this channel, in the order that all channels of this kind
//     /// were opened.
//     /// 
//     /// Assuming that the following channels were opened:
//     /// * `Unreliable`
//     /// * `Reliable`
//     /// * `Unreliable`
//     /// * `Reliable`
//     /// 
//     /// The corresponding channel IDs would be:
//     /// * `ChannelId { kind: Unreliable, index: 0 }`
//     /// * `ChannelId { kind: Reliable, index: 0 }`
//     /// * `ChannelId { kind: Unreliable, index: 1 }`
//     /// * `ChannelId { kind: Reliable, index: 1 }`
//     pub index: usize,
// }
